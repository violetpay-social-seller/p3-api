...
public record OrderFormFieldGroupResult(
    UUID id, String title, String description, int sortOrder, List<OrderFormFieldResult> fields) {
  ...
  public static OrderFormFieldGroupResult of(
    ...
    return new OrderFormFieldGroupResult(
        group.getId(), group.getTitle(), group.getDescription(), group.getSortOrder(), fields);
  }
}
