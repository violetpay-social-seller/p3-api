...
public record StoreAssetCommand(
    InputStream inputStream, String objectKey, String contentType, long sizeBytes) {
  ...
  public static StoreAssetCommand from(RegisterAssetCommand command, String objectKey) {
    return new StoreAssetCommand(
        command.inputStream(), objectKey, command.contentType(), command.sizeBytes());
  }
}
